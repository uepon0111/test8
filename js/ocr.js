...
import { getDeviceProfile, ensureSettingsShape } from "./device.js";
...
export async function analyzeLoadedImage(imgElement, worker, deviceKey = null) {
  try {
    const settings = getDeviceProfile(ensureSettingsShape(state.settings), deviceKey).cropRegions || DEFAULT_CROP_SETTINGS;
